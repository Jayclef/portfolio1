...
export default async function Job() {
  ...
  return (
    <section className="mt-6 py-8 dark:bg-black">
      <div className="mb-16">
        <h2 className="dark:text-[#ccc] font-semibold text-4xl mb-4">Work Experience</h2>
      </div>
        ...
        {job.map((data) => (
          ...
          >
            ...
            <div className="flex flex-col items-start">
              <h3 className="text-xl font-bold dark:text-[#ccc]">{data.name}</h3>
              <p className="dark:text-[#ccc]">{data.jobTitle}</p>
